					...
					<div className="container-fluid">
						<div className="row">
							<div className="col-xl-3 col-lg-3 col-md-6 col-8  d-flex align-items-center">
								<div className="logo">
									<Link href="/" as="/"><img src={require("../../../../public/assets/img/logo/logo.png")} alt="" /></Link>
								</div>
							</div>
							...
							<div className="col-xl-6 col-lg-7 d-none d-lg-block">
								<div className="main-menu text-right">
									<nav id="mobile-menu">
										<ul>
											<li><Link href="/" as="/"><a>home <i><FontAwesomeIcon icon={['fal', 'angle-down']} /></i></a></Link>
											...
											<li><Link href="/service-1" as="/service-1"><a>Service <i><FontAwesomeIcon icon={['fal', 'angle-down']} /></i></a></Link>
												<ul className="sub-menu text-left">
											...
											<li><Link href="/blog" as="/blog"><a>blog <i><FontAwesomeIcon icon={['fal', 'angle-down']} /></i></a></Link>
												<ul className="sub-menu text-left">
											...
											<li><Link href="/" as="/"><a>Pages <i><FontAwesomeIcon icon={['fal', 'angle-down']} /></i></a></Link>
												<ul className="sub-menu text-left">
								...
								<div className="header-right f-right ">
									...
									<div className="header-lang pos-rel f-right d-none d-xl-block">
										<div className="lang-icon">
											...
											<a href="">English <i><FontAwesomeIcon icon={['fal', 'angle-down']} /></i></a>
										</div>

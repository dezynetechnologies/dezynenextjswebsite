                                ...
                                <div class="col">
                                    <div class="our-case-wrapper">
                                        ...
                                        <div class="our-case-text">
                                            ...
                                            <a href="#"> <span class="cases-button">learn more <i><FontAwesomeIcon icon={['fas', 'long-arrow-right']} /></i></span> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                    ...
                    <div class="row">
                       ...
                       <div class="col-xl-5 col-lg-6">
                            <div class="cta-button text-lg-right mb-30">
                                <a class="btn btn-white btn-none" href="#"><span class="btn-text">contact us <i><FontAwesomeIcon icon={['fas', 'long-arrow-right']} /></i></span> </a>
                                <a class="btn btn-white btn-none btn-margin" href="#"><span class="btn-text">join with us <i><FontAwesomeIcon icon={['fas', 'long-arrow-right']} /></i></span> </a>
                            </div>
                       </div>
                    </div>
                </div>

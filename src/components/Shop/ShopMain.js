                                        ...
                                        <div class="col-lg-8">
                                            <div class="product-list-content pt-10">
                                                ...
                                                <div class="product-action-list">
                                                    <a class="btn" href="#"><span class="btn-text">add to cart <i><FontAwesomeIcon icon={['far', 'long-arrow-right']} /></i></span> </a>
                                                    <a class="action-btn" href="#"> <i><FontAwesomeIcon icon={['fal', 'heart']} /></i></a>

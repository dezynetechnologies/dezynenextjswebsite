                                ...
                                <article className="postbox post format-image mb-40">
                                    ...
                                    <div className="postbox__text bg-none">
                                        <div className="post-meta mb-15">
                                            <span><i><FontAwesomeIcon icon={['far', 'calendar-check']} /></i> September 15, 2018 </span>
                                            <span><a href="#"><i><FontAwesomeIcon icon={['far', 'user']} /></i> Diboli B. Joly</a></span>
                                            <span><a href="#"><i><FontAwesomeIcon icon={['far', 'comments']} /></i> 23 Comments</a></span>
                                        </div>

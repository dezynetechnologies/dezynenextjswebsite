                            ...
                            <div class="our-services-wrapper mb-30">
                                ...
                                <div class="our-services-content">
                                    ...
                                    <div class="our-services-text">
                                        ...
                                        <a href="#">view more <i><FontAwesomeIcon icon={['fas', 'long-arrow-right']} /></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="our-services-wrapper mb-30">
                                ...
                                <div class="our-services-content">
                                    ...
                                    <div class="our-services-text">
                                        ...
                                        <p>Set perspiciatis unde omnis iste  natus error sit voluptatem accusan tium demqu laudantium </p>
                                        <a href="#">view more <i class="fal fa-bullhorn"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="our-services-wrapper mb-30">
                                ...
                                <div class="our-services-content">
                                    ...
                                    <div class="our-services-text">
                                        ...
                                        <p>Set perspiciatis unde omnis iste  natus error sit voluptatem accusan tium demqu laudantium </p>
                                        <a href="#">view more <i class="fal fa-cog"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="services-button text-center mt-30">
                                <a class="btn" href="#"><span class="btn-text">view All Services <i><FontAwesomeIcon icon={['fas', 'long-arrow-right']} /></i></span> </a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-7 col-lg-7 ">
                            <div class="contact-wrapper mb-30">
                                ...
                                <form action="assets/mail.php" id="contact-form">
                                            ...
                                            <div class="col-xl-12">
                                                <button class="btn" type="submit"><span class="btn-texts">send message <i><FontAwesomeIcon icon={['fas', 'long-arrow-right']} /></i></span> <span class="btn-border"></span></button>
                                            </div>
                                        </div>

...
const Contact = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(
        `https://a7nc25hxrb.execute-api.us-east-2.amazonaws.com/Test/contact-us`,
        formData,
        { headers: headerData }
      )
      .then((res) => {
        console.log("Email Sent to the site maintainers!");
      });
  };
            ...
            <div className="col-xl-5 col-lg-5 mb-30">
              <div className="map-wrapper">
                ...
                >
                  <GoogleMapReact
                    bootstrapURLKeys={{
                      key: "AIzaSyBGb4srwTkHFqM1wFmxVrNLI-56DoBD9EM",
                      libraries: ["places"],
                    }}
